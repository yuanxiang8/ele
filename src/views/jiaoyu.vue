...
<div class="ding">
    ...
    <div class="jian2">
        ...
        <div class="shou1">
            <span class="shou2">输入搜索</span><input v-model="zhi1" class="shou4" type="text" placeholder="输入文章标题关键字...">
    ...
    <div class="tian1">
        <div class="jian3">
            <i class="el-icon-s-unfold"></i>教育列表
        </div>
        ...
        <div class="tian4">
            <el-table ref="multipleTable" :header-cell-style="rowClass" :cell-style="cellStyle" :data="showTable" tooltip-effect="dark" style="width: 100%;" @selection-change='selectRow'>
                ...
                <el-table-column prop="name" label="标题" width="140" style="text-align: center;">
                </el-table-column>
