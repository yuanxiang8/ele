...
<div class="ding">
    ...
    <div class="jian2">
        ...
        <div class="shou1">
            <span class="shou2">输入搜索</span><input v-model="zhi1" class="shou4" type="text" placeholder="输入课程标题...">
    ...
    <div class="tian1">
        <div class="jian3">
            <i class="el-icon-s-unfold"></i>用户列表
        </div>
        <div class="tian2" @click="dialogFormVisible = true">
            <i class="el-icon-plus"></i><span>新增课程</span>
        </div>
        ...
        <div class="tian4">
            <el-table ref="multipleTable" :header-cell-style="rowClass" :cell-style="cellStyle" :data="showTable" tooltip-effect="dark" style="width: 100%;" @selection-change='selectRow'>
                ...
                <el-table-column prop="name" label="微信昵称" width="140" style="text-align: center;">
                </el-table-column>
...
export default {
    data() {
        return {
            ...
            value2: '',
            pagesize: 3, //设置每页显示条目个数为10
            currentPage: 1, //设置当前页默认为1
            tableData: [{
                id: 1,
                index: '1',
                name: '爱吃阿司匹林的喵',
                img: require("../../public/img/t2.png"),
                date: '2016-05-03',
